...
menu_func.add_command(label="Cadastro de Usuários",command=lambda: AbreTela("usuarios.py"), accelerator="Alt+ U", underline=0)
...
tela.bind_all("<Alt-u>", lambda e: AbreTela("usuarios.py"))
